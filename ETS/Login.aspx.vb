...
Public Class Login
    ...
    Protected Sub btnLogin_Click(sender As Object, e As EventArgs)
        ...
        If txtUsername.Text <> "" And txtPassword.Text <> "" Then
            ...
            If fn_ValidateUser(txtUsername.Text, txtPassword.Text) Then
                ...
                Session("C") = chkPersistCookie.Checked

                Dim strUserNetworkDomain = IPGlobalProperties.GetIPGlobalProperties().DomainName.ToUpper
                Dim strAllowedNetworkDomains = ConfigurationManager.AppSettings.Get("AllowedNetworks")

                If Not strAllowedNetworkDomains.Contains(strUserNetworkDomain) Then
    ...
    Private Sub sb_SendOtp(Username As String, strOtp As String)
        ...
        If connessioneDb.StatoConnessione = 0 Then
            ...
            If connessioneDb.StatoConnessione > 0 Then
                objCommand.CommandType = CommandType.StoredProcedure
                objCommand.CommandText = "Send_Otp_Mail_Html_Format"
                objCommand.Connection = connessioneDb.Connessione

                objCommand.Parameters.AddWithValue("@Username", Username)
                objCommand.Parameters.AddWithValue("@Otp", strOtp)
